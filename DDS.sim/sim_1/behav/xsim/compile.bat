...
REM
REM Generated by Vivado on Tue Mar 24 20:37:34 +0800 2026
...
echo "xvlog --incr --relax -prj tb_dds_top_vlog.prj"
call xvlog  --incr --relax -prj tb_dds_top_vlog.prj -log xvlog.log
