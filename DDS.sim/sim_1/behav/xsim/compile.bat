...
REM
REM Generated by Vivado on Thu Mar 19 17:47:42 +0800 2026
...
echo "xvlog --incr --relax -prj tb_accumulator_vlog.prj"
call xvlog  --incr --relax -prj tb_accumulator_vlog.prj -log xvlog.log
