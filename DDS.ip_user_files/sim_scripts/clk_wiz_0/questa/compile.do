...
vlog -work xpm  -incr -mfcu  -sv "+incdir+../../../ipstatic" "+incdir+F:/AMDDesignTools/2025.2/Vivado/data/rsb/busdef" \
...
vlog -work xil_defaultlib  -incr -mfcu  "+incdir+../../../ipstatic" "+incdir+F:/AMDDesignTools/2025.2/Vivado/data/rsb/busdef" \
