...
#
# Script generated by Vivado on Tue Mar 24 20:20:27 +0800 2026
...
#                blk_mem_gen_0.sh [-rerun]
#                blk_mem_gen_0.sh [-reset_run]
#                blk_mem_gen_0.sh [-clean]
...
export RDI_DATADIR="F:/AMDDesignTools/2025.2/Vivado/data"
...
# script info
echo -e "blk_mem_gen_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_0 xil_defaultlib.blk_mem_gen_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="F:/AMDDesignTools/2025.2/Vivado/data/xsim"
  fi
...
Usage: blk_mem_gen_0.sh [-rerun]\n\
Usage: blk_mem_gen_0.sh [-reset_run]\n\
Usage: blk_mem_gen_0.sh [-clean]\n\
